...
public class StorageTest extends TestCase {
    ...
    protected void setUp() throws java.lang.Exception {
        ...
        storage.setProperty("perst.reload.objects.on.rollback", true);
    }
    ...
    public void testTransaction01(){
        storage.open(new NullFile(), INFINITE_PAGE_POOL);
        Root root = new Root(storage.createSet());
        root.i = 10;
        storage.setRoot(root);
        storage.commit();
        root.i = 20;
     ...
     * Internal class.
     */
    private static class Root2 extends Persistent {
        IPersistentSet records;
        Integer i;
        Root next;
        String s;
        double d;
        public Root2(IPersistentSet records){
            this.records = records;
        }
        public Root2(){
        }
