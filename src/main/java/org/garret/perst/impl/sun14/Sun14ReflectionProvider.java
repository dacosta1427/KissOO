...
//            java.io.ObjectStreamClass$tFieldReflector.
//            Field unsafeField2 = Unsafe.class.getDeclaredField("theUnsafe");
//            unsafeField2.setAccessible(true);
//            Unsafe unsafe = (Unsafe) unsafeField.get(null);

            Object unsafeImpl;
            try {
                unsafeField.setAccessible(true);
                unsafeImpl = unsafeField.get(null);
            } catch (Exception e) {
