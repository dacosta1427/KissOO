...
describe('Users API', () => {
  ...
  describe('getUsers', () => {
    it('should call Server.call with correct parameters', async () => {
      ...
      expect(Server.call).toHaveBeenCalledWith('services.koo.Users', 'getUsers', {});
    });
  ...
  describe('addUser', () => {
    it('should call Server.call with correct parameters', async () => {
      ...
      expect(Server.call).toHaveBeenCalledWith('services.koo.Users', 'createUser', {
        userName: 'newuser',
  ...
  describe('deleteUser', () => {
    it('should call Server.call with correct parameters', async () => {
      ...
      expect(Server.call).toHaveBeenCalledWith('services.koo.Users', 'deleteUser', { id: 123 });
    });
  ...
  describe('updateUser', () => {
    it('should call Server.call with correct parameters', async () => {
      ...
      expect(Server.call).toHaveBeenCalledWith('services.koo.Users', 'updateUser', {
        id: 123,
    ...
    it('should handle all active status values', async () => {
      ...
      expect(Server.call).toHaveBeenLastCalledWith('services.koo.Users', 'updateUser',
