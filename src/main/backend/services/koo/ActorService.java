 ...
 * {
 *   "_class": "services.koo.ActorService",
...
public class ActorService {
    ...
    public static final EndpointMethod GET_ACTOR = new EndpointMethod("services.koo.ActorService.getAActor", AActor.class) {
        @Override
    ...
    /** Get all actors */
    public static final EndpointMethod GET_ALL_ACTORS = new EndpointMethod("services.koo.ActorService.getAllActors", AActor.class) {
        @Override
        protected boolean doExecute(JSONObject in, JSONObject out, Connection db, ProcessServlet servlet) {
            AActor caller = getAuthenticatedActor(servlet);
            if (caller == null) {
    ...
    /** Create a new actor */
    public static final EndpointMethod CREATE_ACTOR = new EndpointMethod("services.koo.ActorService.createActor", AActor.class) {
        @Override
        protected boolean doExecute(JSONObject in, JSONObject out, Connection db, ProcessServlet servlet) {
            AActor caller = getAuthenticatedActor(servlet);
            if (caller == null) {
    ...
    /** Update an actor */
    public static final EndpointMethod UPDATE_ACTOR = new EndpointMethod("services.koo.ActorService.updateActor", AActor.class) {
        @Override
        protected boolean doExecute(JSONObject in, JSONObject out, Connection db, ProcessServlet servlet) {
            AActor caller = getAuthenticatedActor(servlet);
            if (caller == null) {
    ...
    /** Delete an actor */
    public static final EndpointMethod DELETE_ACTOR = new EndpointMethod("services.koo.ActorService.deleteActor", AActor.class) {
        @Override
        protected boolean doExecute(JSONObject in, JSONObject out, Connection db, ProcessServlet servlet) {
            AActor caller = getAuthenticatedActor(servlet);
            if (caller == null) {
    ...
    public static final EndpointMethod DO_INTERNAL_CALC = new EndpointMethod("services.koo.ActorService.doInternalCalc", AActor.class, false) {
        @Override
        protected boolean doExecute(JSONObject in, JSONObject out, Connection db, ProcessServlet servlet) {
