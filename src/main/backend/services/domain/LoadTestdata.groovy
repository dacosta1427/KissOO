        ...
        try {
            ...
            ownerData.each { d ->
                try {
                    ...
                    // Set password to pw123 for all test users
                    owner.getPerstUser().setPassword("pw123")
            ...
            def houses = []
            def houseInsertTc = StorageManager.createContainer()
...
def cleaners = []
            ...
            cleanerData.each { d ->
                try {
                    ...
                    // Set password to pw123 for all test users
                    cleaner.getPerstUser().setPassword("pw123")
