...
function _page($$renderer, $$props) {
  $$renderer.component(($$renderer2) => {
    ...
    if (isAuthenticated()) {
      ...
      $$renderer2.push("<!--[-1-->");
      $$renderer2.push(`<main class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-4"><div class="flex justify-center"><div class="bg-white p-6 rounded-lg shadow-md w-full max-w-md"><h1 class="text-2xl font-bold text-center mb-4">${escape_html(tt("auth.login_title"))}</h1> `);
      {
        $$renderer2.push("<!--[-1-->");
      }
