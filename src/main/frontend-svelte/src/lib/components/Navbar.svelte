    ...
    <div class="flex justify-between items-center h-16">
      ...
      <nav class="hidden md:flex items-center space-x-4">
        ...
        {#if session.isAuthenticated}
          ...
          <div class="relative">
            <button 
              onclick={() => demoMenuOpen = !demoMenuOpen}
            ...
            {#if demoMenuOpen}
              <div class="absolute right-0 mt-2 w-48 bg-white rounded-md shadow-lg py-1 z-50 border border-gray-200">
                ...
                <a href="/file-upload" class="block px-4 py-2 text-sm text-gray-700 hover:bg-gray-100">File Upload</a>
                <a href="/ollama" class="block px-4 py-2 text-sm text-gray-700 hover:bg-gray-100">Ollama AI</a>
                <a href="/controls" class="block px-4 py-2 text-sm text-gray-700 hover:bg-gray-100">Controls</a>
                <div class="border-t border-gray-200 my-1"></div>
                <a href="/sql-access" class="block px-4 py-2 text-sm text-gray-700 hover:bg-gray-100">SQL Access</a>
                <a href="/report" class="block px-4 py-2 text-sm text-gray-700 hover:bg-gray-100">Report</a>
                <a href="/export" class="block px-4 py-2 text-sm text-gray-700 hover:bg-gray-100">Export</a>
              </div>
            {/if}
          </div>
      ...
      <div class="md:hidden pb-4">
        <div class="flex flex-col space-y-2">
          ...
          {#if session.isAuthenticated}
            ...
            <a href="/file-upload" class="text-gray-600 hover:text-gray-900 font-medium">File Upload</a>
            <a href="/ollama" class="text-gray-600 hover:text-gray-900 font-medium">Ollama AI</a>
            <a href="/controls" class="text-gray-600 hover:text-gray-900 font-medium">Controls</a>
            <div class="border-t border-gray-200 my-2"></div>
            <a href="/sql-access" class="text-gray-600 hover:text-gray-900 font-medium">SQL Access</a>
            <a href="/report" class="text-gray-600 hover:text-gray-900 font-medium">Report</a>
            <a href="/export" class="text-gray-600 hover:text-gray-900 font-medium">Export</a>
            <div class="border-t border-gray-200 my-2"></div>
            <button
              onclick={handleLogout}
...
<svelte:window onclick={() => { if (demoMenuOpen) demoMenuOpen = false; }} />
