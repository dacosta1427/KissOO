...
> See [working-rules.md](../development/working-rules.md) for core operating principles
...
**Current Environment:** OpenJDK 21
...
1. See `docs/` directory for documentation ✓
