...
**Last Updated**: 2026-03-25 (Owner now extends Actor, inheriting PerstUser relationship. Signup creates User and Owner with proper linkage.)  
**Next Review**: After testing Owner-User retrieval and frontend integration (protocol requires updates within 4 hours of task completion)